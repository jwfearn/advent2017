defmodule D04 do
  def count_valid(lines, fun \\ & &1) do
    lines
    |> String.split("\n")
    |> Enum.count(&valid?(&1, fun))
  end

  def sort(s), do: s |> String.graphemes |> Enum.sort |> Enum.join
...
defmodule D04Test do
  ...
  test "case 1", do: assert D04.count_valid("aa bb cc dd ee") == 1
  test "case 2", do: assert D04.count_valid("aa bb cc dd aa") == 0
  test "case 3", do: assert D04.count_valid("aa bb cc dd aaa") == 1
  ...
  test "part 1", do: assert D04.count_valid(@input) == 325
  test "part 2", do: assert D04.count_valid(@input, &D04.sort/1) == 119
end
